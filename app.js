...
},{"./lib/chord":3,"./lib/interval":4,"./lib/note":6,"./lib/scale":7,"./lib/sugar":8}],3:[function(require,module,exports){
...
},{"./interval":4,"./knowledge":5,"./note":6,"daccord":10}],4:[function(require,module,exports){
var knowledge = require('./knowledge');
...
},{"./knowledge":5,"./vector":9,"interval-coords":14}],5:[function(require,module,exports){
...
},{"./interval":4,"./knowledge":5,"./vector":9,"helmholtz":11,"scientific-notation":15}],7:[function(require,module,exports){
var knowledge = require('./knowledge');
var Interval = require('./interval');
...
},{"./interval":4,"./knowledge":5}],8:[function(require,module,exports){
var knowledge = require('./knowledge');
...
},{"./knowledge":5}],9:[function(require,module,exports){
module.exports = {
...
},{"accidental-value":12,"notecoord":13}],12:[function(require,module,exports){
...
var _synths2 = _interopRequireDefault(_synths);
...
var config = {
  dropVoices: 6,
  scaleNotes: 7,
  scale: _teoria2.default.note('a4').scale('minor')
};
...
exports.default = function () {
  ...
  var dropSynth = new _Tone2.default.PolySynth(config.dropVoices, _synths2.default);

  var delay = new _Tone2.default.FeedbackDelay('3n', 0.4);
  delay.set('wet', 0.3);

  var reverb = new _Tone2.default.Freeverb();

  var filter = new _Tone2.default.Filter(400, 'lowpass');

  var comp = new _Tone2.default.Compressor(-30, 2);

  var volume = new _Tone2.default.Volume(-10);

  dropSynth.chain(delay, reverb, filter, comp, volume, _Tone2.default.Master);
...
exports.default = function (sceneWidth, sceneHeight) {
  ...
  var audioSystem = (0, _audio2.default)();
  ...
  var wall = (0, _wall2.default)(wallWidth, wallHeight, config.tilesize);
  scene.add(wall.mesh);
  ...
  var render = function render(t) {
    try {
      ...
      requestAnimationFrame(function () {
        return render(t + config.animationSpeed);
      });
    } catch (e) {
  ...
  var click = function click(xVal, yVal) {
    mouse.x = xVal * 2 - 1;
    mouse.y = -(yVal * 2) + 1;
    raycaster.setFromCamera(mouse, camera);
    var intersects = raycaster.intersectObjects([wall.mesh]);
    if (intersects.length > 0) {
      var p = intersects[0].face.a;
      var xPos = Math.floor(p / wall.points.yPoints);
      var yPos = p % wall.points.yPoints;
...
var Drop = exports.Drop = function () {
  function Drop(options) {
    ...
    _Tone2.default.Monophonic.call(this, options);

    this.oscillator = new _Tone2.default.OmniOscillator(options.oscillator);

    this.frequency = this.oscillator.frequency;

    this.detune = this.oscillator.detune;

    this.envelope = new _Tone2.default.AmplitudeEnvelope(options.envelope);
  ...
  _createClass(Drop, [{
    ...
    value: function dispose() {
      _Tone2.default.Monophonic.prototype.dispose.call(this);
...
_Tone2.default.extend(Drop, _Tone2.default.Monophonic);

},{"Tone":1}],23:[function(require,module,exports){
'use strict';
...
var applyHeightMap = function applyHeightMap(wall, rippleHeight, heightMap) {
  var x = void 0,
      y = void 0;
  for (x = 0; x < heightMap.x; x += 1) {
    for (y = 0; y < heightMap.y; y += 1) {
...
exports.default = function (xPoints, yPoints, tileSize) {
